...
\begin{list1}
  \item[] {\bf \small Project:} NumPy
  \begin{list2}
    \item Maintainer of the NumPy array computation library.
    \item Code development, documentation \& testing, code review, and project
          infrastructure.
  \end{list2}
  \item[] {\bf \small NetworkX Core Developer}
  \begin{list2}
    \item Joined the core development team for the NetworkX library
    \item Code development, documentation \& testing, code review, and project
          infrastructure.
  \end{list2}
  \item[] {\bf \small BIDS COVID-19 Data Science Consultation Service}
  \begin{list2}
    \item Core team member for planning and implementing web portal for BIDS
          COVID-19 data science consultation service.
          The goal of the project is to link data science experts from BIDS
          with domain-experts conducting research related to COVID-19.
  \end{list2}
\end{list1}
