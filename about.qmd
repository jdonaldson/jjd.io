...
about:
  ...
  links:
    ...
    - icon: linkedin
      text: LinkedIn
      href: https://www.linkedin.com/in/jjustindonaldson/
...
music discovery. For further details, visit the [publications section](cv.qmd#publications)
...
analysis.  Visit the [patents section](cv.qmd#patents) for more details.
...
More details in the [pro-bono](cv.qmd#pro-bono) section.


# Curvo Labs (Chief Data Scientist)

![Curvo Labs Team - Franco Ponticelli (CTO), Justin Donaldson (Chief Data Scientist), Andy Perry (CEO)](images/IMG_9382.jpg)
...
while working on cutting-edge research and applications alongside CTO [Franco Ponticelli](https://github.com/fponticelli) and CEO [Andy Perry](https://www.linkedin.com/in/perryandy/).
