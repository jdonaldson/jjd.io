...
[Max Carey](https://en.wikipedia.org/wiki/Max_Carey) safe at second on a steal, 1925 World Series. Fittingly, the best thief in this post already knew the rule. A steal is worth ~+0.2 runs, a caught stealing ~−0.4 — a break-even near a **70% success rate**, the same replacement-level bar the out-cost sets. Carey stole 738 bases not by running more than everyone else, but by only running when the odds cleared it: **51-for-53 (96%)** in 1922, and **+96 career baserunning runs** ([Baseball-Reference](https://www.baseball-reference.com/players/c/careyma01.shtml)), nearly his **+118** with the bat. The move worth stealing isn't the stolen base. It's the discipline of measuring against replacement before you go. *(Photo: Library of Congress / National Photo Company. Public domain.)*
:::
