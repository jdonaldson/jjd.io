...
![Seven adjective categories fit as scalar frames in SmolLM2-1.7B. Six are strongly recoverable on held-out words (r 0.79–0.99); color is the interesting failure. Labels show the layer where each frame peaks.](images/frames_recoverability.png){fig-alt="Bar chart of held-out cross-validation r for seven adjective-ordering rungs: opinion 0.99, size 0.98, age 0.91, shape 0.93, color 0.28, space 0.89, material 0.80, with peak layers annotated on each bar."}
...
![Peak-recoverability layer against position in the canonical adjective order. Early rungs are computed early, late rungs late.](images/frames_depth.png){fig-alt="Scatter plot of adjective-ordering position (1 through 7) against the layer of peak recoverability, showing opinion, size, age and shape clustered at layers 1 through 4 and color, space and material at layers 17 and 18, with a dashed upward trend line."}
