...
Enter **Krapivin hash tables** ([Krapivin et al. 2025](https://arxiv.org/abs/2501.02305)), which provide O(1) density queries through their hierarchical structure. You can instantly ask: "Which buckets have ≥5 items?" without scanning anything.
...
3. **Discover**: Query Krapivin hash table for buckets with ≥5 items (O(1) operation)
